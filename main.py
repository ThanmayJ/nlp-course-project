...
class SearchEngine:
    ...
    def __init__(self, args):
        ...
        if getattr(self.args, 'improved', False):
            self.informationRetriever = ImprovedInformationRetrieval()
        else:
    ...
    def evaluateDataset(self):
        ...
        plt.xlabel("k")
        plot_name = "eval_plot_improved.png" if getattr(self.args, 'improved', False) else "eval_plot.png"
        plt.savefig(os.path.join(args.out_folder, plot_name))
